...
export function HomeScreen({ setPlayerMarkers }: Readonly<HomeScreenProps>) {
  ...
  return (
    <main className='bg-dark-navy flex h-full min-h-screen items-center justify-center'>
      <div className='animate-slide-up flex flex-col items-center gap-8 md:gap-10'>
        <Image
          src='/images/logo.svg'
          width={71.22}
          height={31.74}
